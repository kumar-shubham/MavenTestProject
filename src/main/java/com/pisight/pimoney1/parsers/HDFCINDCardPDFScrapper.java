...
public class HDFCINDCardPDFScrapper extends PDFParser {
	...
	private static CardAccount scrapeStatement(WebDriver driver){
		...
		String accountName = "HDFC BANK LTD";
		WebElement branchEle = page.findElement(By.xpath("//td[contains(text(), 'Account Branch :')]/"));
		String branchRow = branchEle.getText();
		branchRow = branchRow.replace("Account Branch :", "").trim();
		String branch = branchRow.substring(0, branchRow.indexOf(",")).trim();
		System.out.println("Account Name:::: " + accountName);
		System.out.println("Branch Name:::: " + branch);

		WebElement nameEle = page.findElement(By.xpath("//td[contains(text(), 'M/')]"));
		String nameRow = nameEle.getText();
		String name = nameRow.substring(0, nameRow.indexOf("City")).trim();
